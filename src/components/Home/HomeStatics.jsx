            ...
            <div className="statics-content">
                ...
                <div className="statica">
                    <div className="statics-item m-2">
                        ...
                        <div className="counter text-white m-4 text-center" data-target="2021">0</div>
                    ...
                    <div className="statics-item m-2">
                        ...
                        <div className="counter text-white m-4 text-center" data-target="2">0</div>
                    ...
                    <div className="statics-item m-2">
                        ...
                        <div className="counter text-white m-4 text-center" data-target="7">0</div>
